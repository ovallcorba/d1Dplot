...
public class DataPoint_hkl extends BasicPoint {
    ...
    public DataPoint_hkl(HKLrefl hkl, DataSerie parent) {
        this(hkl.getDsp(),hkl.getYcalc(),0,hkl,parent);
    }
    
    public DataPoint_hkl(HKLrefl hkl,double xval, DataSerie parent) {
        this(xval,hkl.getYcalc(),0,hkl,parent);
    }
    
    public DataPoint_hkl(double px, double py, double pysd, HKLrefl hkl, DataSerie parent) {
